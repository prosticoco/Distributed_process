...
_DEPS = addrbook.h data.h dependencies.h error.h log.h layers.h layerzero.h mqueue.h parser.h pending.h plink.h receiver.h sender.h urb.h
DEPS = $(patsubst %, $(IDIR)/%, $(_DEPS))
_SRCOBJ = addrbook.o beb.o da_proc.o dependencies.o flink.o layerzero.o log.o mqueue.o parser.o pending.o plink.o receiver.o sender.o urb.o lcb.o
